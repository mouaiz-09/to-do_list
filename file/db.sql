...
--
-- Host: 127.0.0.1
-- Generation Time: 01 يناير 2025 الساعة 14:36
...
-- Database: `abdo`
--
CREATE DATABASE IF NOT EXISTS `abdo` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `abdo`;
...
('root', '[{\"db\":\"todo-list\",\"table\":\"task\"},{\"db\":\"abdo\",\"table\":\"user\"}]');
...
('root', 'todo-list', 'task', '{\"sorted_col\":\"`taskname` ASC\"}', '2024-12-30 17:23:43');
...
('root', '2025-01-01 13:04:04', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"ar\",\"NavigationWidth\":242,\"ThemeDefault\":\"bootstrap\"}');
